...
1. 下载本插件.
2. 新建 `.seml` 后缀文件, 使用 `Ctrl + Shift + P` 呼出命令菜单, 键入 `使用砸率模板`.
或者手动输入以下内容:
```
# 测试 PE.垫材24 旧PDc解的砸率
scene:PE
...
1. 下载本插件.
2. 新建 `.seml` 后缀文件, 使用 `Ctrl + Shift + P` 呼出命令菜单, 键入 `使用炮伤模板`.
或者手动输入以下内容:
```
...
1. 下载本插件.
2. 新建 `.seml` 后缀文件, 使用 `Ctrl + Shift + P` 呼出命令菜单, 键入 `使用刷新模板`.
或者手动输入以下内容:
```
...
1. 下载本插件.
2. 新建 `.seml` 后缀文件, 使用 `Ctrl + Shift + P` 呼出命令菜单, 键入 `使用跳跳模板`.
或者手动输入以下内容:
```
